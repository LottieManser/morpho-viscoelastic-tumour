...
% Plot the evolution of spheroid radii for two outputs on the same axes.
    ...
    plot(t2, output2.radialStresses(:,end) / output2.params.L, 'k--', 'LineWidth', 1.5)
    ...
    if any(output1.nutrients(:) == 0) || any(output2.nutrients(:) == 0)
        ...
        plot(t1, output1.radialStresses(zeroNutrientInds1)/output1.params.L, 'Color',0.4*[1,1,1], 'LineWidth',1)
